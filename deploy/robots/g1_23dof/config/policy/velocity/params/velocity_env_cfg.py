...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformLevelVelocityCommandCfg(
        ...
        debug_vis=True,
        # 初始的ranges，可以根据任务CurriculumCfg进行修改，但是实际上limit_ranges也可以修改，只是为了区分而以
...
@configclass
class EventCfgDebug:
    """Debug events for Isaac-MuJoCo first-frame alignment."""
